...
- [ ] 🔵 **동물 퍼즐 (10종)**: 배경 통째 직소퍼즐 + 이름 스펠링 + 동물 영상 보상. 프로토타입 `proto-animal.html`(코끼리) 완성, **본게임 통합 대기**. 동물별로 에셋 필요(장면그림 + 완성영상 + 선택:이름음성). 순서/문구:
  1. 🦁 사자 Lion — "어흥! 갈기가 멋져요"  (Animal-lion.png 있음/배경버전·영상 미정)
  2. 🐘 코끼리 Elephant — "코가 정말 길어요"  ✅ 프로토 완성(이미지·영상·소리 다 됨)
  3. 🦒 기린 Giraffe — "목이 하늘까지 닿아요"
  4. 🐯 호랑이 Tiger — "줄무늬가 멋져요"
  5. 🐻 곰 Bear — "꿀을 좋아해요"
  6. 🐰 토끼 Rabbit — "깡충깡충 뛰어요"
  7. 🐵 원숭이 Monkey — "나무를 잘 타요"
  8. 🐧 펭귄 Penguin — "뒤뚱뒤뚱 걸어요"
  9. 🐋 고래 Whale — "바다에서 제일 커요"
  10. 🐨 코알라 Koala — "나무에 꼭 안겨 있어요"
