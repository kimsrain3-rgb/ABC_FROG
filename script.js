...
function cf(l,t,sx,sy){
  ...
  e.className='fly';
  const dir=DIRS[Math.floor(Math.random()*3)];e.dataset.dir=dir;const dl=displayLetter(l);const lowerCls=dl!==dl.toUpperCase()?' lower':'';e.innerHTML='<img class="fly-sprite" src="'+FLY_IMGS[dir][0]+'"><div class="fly-letter'+lowerCls+'">'+dl+'</div><div class="fly-slime">💧</div>';
