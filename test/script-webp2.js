// ★ 테스트 전용 복사본 — 그림 WebP 전환 2차 (개구리) 2026-08-26
//   바탕: 라이브 script.js 그대로. 다른 점은 개구리 그림 주소 2곳뿐.
//     ① 7줄  f.src='...frog_4'+(t?'b':'a')+'.webp'  ← 이름을 글자로 이어 붙이는 자리(검색으로 안 잡힌다)
//     ② wc-frog 의 frog_4a.webp
