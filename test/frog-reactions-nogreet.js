/* =====================================================================
   ...
   ★ 라이브에 반영되어 있음 — index.html 이 script.js 뒤에서 이 파일을 로드한다.
     (2026-07-21 커밋 a8dfd11 로 실유저 공개. 예전 "테스트 전용, 라이브 미반영" 주석은 사실과
      달라 2026-08-10 에 바로잡음 — 옛 주석 때문에 라이브 파일을 테스트 파일로 오해할 뻔했음.)
