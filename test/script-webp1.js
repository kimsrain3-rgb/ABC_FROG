// ★ 테스트 전용 복사본 — 그림 WebP 전환 1차 (2026-08-26)
//   바탕: 라이브 script.js 그대로. 다른 점은 그림 주소만 — 벌레 21종(23곳) + bg_1·bg_4·bg_5 → .webp
//   개구리(frog_*)·과일은 손대지 않았다. 원본 PNG 도 그대로 남아 있어 .webp → .png 로 주소만 되돌리면 복구된다.
//   ⚠ 이 파일을 직접 고치지 말 것 — 검증이 끝나면 라이브 script.js 에 같은 치환을 다시 한다.
